...
public final class ConstantUtils {
    ...
    public final static String THEME_COLOR = "app";
    ...
    public final static class LgInfoUpload {
        public final static String SHARE_KEY = "share_leagoo";
        public final static String INFOUPLOAD_KEY_DATE = "infoupdate_date";
        public final static String INFOUPLOAD_KEY_INTERVAL = "infoupdate_interval";
