...
public class CustomDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public CustomDialog create() {
            ...
            TypefaceUtil.replaceFont(layout);
...
//				layout.findViewById(R.id.message).addView(
...
//								LayoutParams.WRAP_CONTENT));
    ...
    /**
     * 创建对话框，不需要取消按钮，使用默认的Ok监听，直接关闭对话框
     * @param context
     * @param title
     * @param content
     * @return
     */
    public static Dialog showSimpleDialog(@NonNull Context context, @StringRes int title, @StringRes int content) {
        return showDialog(context, title, content, new OnClickListener() {
            @Override
     ...
     * @return
     */
    public static Dialog showDialog(@NonNull Context context, @StringRes int title, @StringRes int content,
                                     DialogInterface.OnClickListener confirmClickListener) {
        return showDialog(context, title, content, confirmClickListener, true);
    }

    public static Dialog showDialog(@NonNull Context context, @StringRes int title, @StringRes int content,
                                    DialogInterface.OnClickListener confirmClickListener, boolean needDfCancelListenner) {
        CustomDialog.Builder builder = new CustomDialog.Builder(context);
        builder.setTitle(title);
        builder.setMessage(content);
        builder.setCancelable(false);
        if (confirmClickListener != null) {
            builder.setPositiveButton(R.string.ok, confirmClickListener);
        }
        if (needDfCancelListenner) {
        ...
        Dialog replenishDialog = builder.create();
