 ...
 */
public class FingerAndPasswordActivity extends BaseActivity {
    ...
    @Inject
    com.victor.fingerprint.FingerprintAuthenticationDialogFragment mFragment;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent intent = new Intent(this, com.victor.fingerprint.SettingsActivity.class);
